...
const WhatNext = () => {
    return (
        <>
            <div className="w-full flex justify-center text-white text-[35px] font-[600] mt-[80px]">What to do next?</div>
            <div className="w-full grid lg:grid-cols-3 gri-col-1 text-white mt-[50px] gap-[30px]">
                ...
                <FadeInWhenVisible className="flex flex-col items-center">
                    ...
                    <p className="text-[25px] font-copihuew05semi_bold_italic">Imagination sub page to see<br /> leaderboard and assets</p>
                </FadeInWhenVisible>
            </div>
        </>
    )
